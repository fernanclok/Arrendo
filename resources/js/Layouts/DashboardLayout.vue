...
const Actions = [
  { href: '/', label: 'Upgrade to Pro', icon: 'star' },
  { href: '/', label: 'Help', icon: 'question-circle' },
  { href: '/', label: 'Sing out', icon: 'shield' }
];
const User = {
    name: 'John Doe',
    ...
    'hidden sm:block': isSidebarOpen
                ...
                <div class="h-full p-2 overflow-y-auto bg-primary-black">
                        <nav class="flex items-center justify-center  border-b border-gray-500 p-6">
                            ...
                            <h1 class="text-gray-300 text-sm font-bold block text-wrap">{{ User.name }} {{ User.email }}</h1>
                        </nav>
                        <ul class="space-y-2 pb-2">
                            ...
                            <ul>
                                <li v-for="action in Actions" :key="action.href" class="flex items-center p-2 text-gray-300 rounded-md hover:bg-secondary focus:ring-white group">
                                    <a :href="action.href" class="text-sm font-thin group-hover:text-gray-900 flex items-center">
            ...
            <nav :class="{
                    ...
                    'flex items-center transition-all duration-300 justify-between rtl:justify-end': true,
                        ...
                        <button @click="toggleSidebar"
                            :aria-controls="'logo-sidebar'"
                            :aria-expanded="isSidebarOpen"
                            type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
                        ...
                        <div class="flex justify-center items-center " >
                            ...
                            <button class="p-2 bg-primary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary" @click="searchProperties">
