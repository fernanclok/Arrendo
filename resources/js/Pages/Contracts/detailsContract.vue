    ...
    <Head title="Contracts" />
        <DashboardLayout>
           ...
           <section class="grid grid-cols-1 sm:grid-cols-2 gap-8 p-4 ">
                ...
                <nav class="block justify-center items-center text-center bg-gray-50 shadow-lg rounded-lg h-fit">
                    <div>
    ...
    <DashboardLayout>
      ...
      <nav v-else class="p-8">
        ...
        <div class="mt-8 flex justify-center">
          <CustomButton @click="backContracts" class="bg-primary text-white py-3 px-8 rounded-lg shadow-md hover:bg-green-600 transition">
