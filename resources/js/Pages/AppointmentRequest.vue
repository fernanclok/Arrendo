                    ...
                    <div v-else class="space-y-4">
                        <div v-for="appointment in appointments" :key="appointment.id"
                            ...
                            <div class="flex items-center justify-between cursor-pointer"
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <button @click.stop="cancelAppointment(appointment.id)"
                                        ...
                                        :disabled="appointment.status === 'Cancelled'"></button>
                                    <i :class="appointment.isOpen ? 'mdi mdi-chevron-up' : 'mdi mdi-chevron-down'"></i>
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <ul class="list-disc ml-6 space-y-1">
                                            ...
                                            <li><i class="mr-2 mdi mdi-ruler"></i><strong class="text-gray-500">Square
                                                    Meters:</strong> {{
                            ...
                            <!-- <div v-if="selectedAppointment"
                                class="fixed z-50 h-auto inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                                <div class="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
                                    <h2 class="text-2xl font-bold mb-4 text-center">Update Appointment Status</h2>
                                    <p class="text-gray-600 mb-4 text-center">The tenant will be notified of the
                                        updated
                                        status.</p>
                                    <form @submit.prevent="updateStatus(appointment.id)">
                                        <div class="space-y-4">
                                            ...
                                            <div v-if="appointmentForm.status === 'Rejected'" class="mt-4">
                                                ...
                                                <p class="text-sm text-gray-600 mt-2">If you reject the appointment,
                                                    the
                                                    tenant will be notified and will be able to request a new
                                                    appointment.
                                                </p>
                                            </div>
                                        </div>
